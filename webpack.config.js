...
var entryPATH = path.resolve(__dirname + '/client/index.js');
var buildPATH = path.resolve(__dirname + '/server/public/');
...
var config = {
    ...
    output: {
        //输出文件夹
        path: prod ? buildPATH : path.resolve(__dirname + '/built/'),
        filename: 'js/[name].js',   //最终打包生成的文件名(只是文件名，不带路径的哦)
...
if (process.env.NODE_ENV === "production") {  // 生产环境
    config.plugins = config.plugins.concat([
        ...
        new HtmlWebpackPlugin({
            ...
            filename: path.resolve(__dirname + '/server/public/index.html'),   // 目标文件
